...
\subsection{Exact algorithm for structural cohesion}
...
\subsection{Heuristics for computing structural cohesion}
...
The structural cohesion model \citep{white:2001,moody:2003} is based on two mathematically equivalent definitions of cohesion (Menger's theorem).
